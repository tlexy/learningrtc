...
#include "3rd/libyuv/include/libyuv/convert.h"
#include "3rd/libyuv/include/libyuv/planar_functions.h"
#include "3rd/libyuv/include/libyuv/scale.h"
...
int I420DataSize(int height, int stride_y, int stride_u, int stride_v) {
  int data_size = stride_y * height + (stride_u + stride_v) * ((height + 1) / 2);
  return data_size;
}
